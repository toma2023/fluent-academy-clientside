    ...
    return (
		<div>
			<div
				...
				style={{
					backgroundImage: `url("https://i.ibb.co/hm50pm7/instructor-cover.jpg")`,
				}}
			>
			...
			<div className='max-w-screen-xl mx-auto'>
				<h2 className='my-14 text-5xl text-center font-bold mb-8'>
					<span className='text-primary'>Our Honourable</span>{" "}
					Instructors
				</h2>
				<div className='my-14 grid md:grid-cols-3 gap-4 mt-12'>
					{instructors?.map(instructor => (
						<div
							key={instructor?._id}
							className='card card-compact w-96 bg-blue-300 shadow-xl'
						>
							<figure>
								<img
