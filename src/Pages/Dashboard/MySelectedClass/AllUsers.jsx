...
const [axiosSecure] = useAxiosSecure();
    ...
    const handleMakeAdmin = user => {
      fetch(`https://fluent-academy-server-toma570.vercel.app/users/admin/${user._id}`, {
            method: 'PATCH',
...
const handleMakeInstructor = user =>{
    fetch(`https://fluent-academy-server-toma570.vercel.app/users/instructor/${user._id}`, {
        method: 'PATCH',
